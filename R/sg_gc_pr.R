...
#############################################################################################
S = readMat(paste('data/gc/', sens, '/Ssg_pr.mat', sep = ''))
...
ggsave(paste(sens, '_Ssg_gc_pr', '.png', sep = ''))
...
#############################################################################################
# load data
St = readMat(paste('data/gc/', sens, '/St_pr.mat', sep = ''))
...
ggsave(paste(sens, '_med_gc_pr', '.png', sep = ''))
