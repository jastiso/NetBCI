...
h = readMat(paste('data/wpli/', sens, '/high_participation.mat', sep = ''))
l = readMat(paste('data/wpli/', sens, '/low_participation.mat', sep = ''))
...
plot + geom_boxplot(notch = FALSE, lwd = 1) + 
  ...
  labs(x = 'Region', y = 'Between Lobe Exp')  + theme_minimal()
...
h_ts = readMat(paste('data/wpli/', sens, '/ts_high_participation.mat', sep = ''))
l_ts = readMat(paste('data/wpli/', sens, '/ts_low_participation.mat', sep = ''))
