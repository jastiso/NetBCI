...
l = readMat(paste('data/gc/', sens, '/mod_exp_low.mat', sep = ''))
...
h_ts = readMat(paste('data/gc/', sens, '/ts_mod_exp_high.mat', sep = ''))
l_ts = readMat(paste('data/gc/', sens, '/ts_mod_exp_low.mat', sep = ''))
