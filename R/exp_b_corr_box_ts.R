# Behavior and BE correlations for null
...
# load data
max = readMat(paste('data/gc/', sens, '/ts_max_exp_b_corr.mat', sep = ''))
min = readMat(paste('data/gc/', sens, '/ts_min_exp_b_corr.mat', sep = ''))
...
ggsave(paste('ts_b_exp_corr', '.png', sep = ''))
