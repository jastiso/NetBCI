...
#############################################################################################
S = readMat(paste('data/wpli/', sens, '/S.mat', sep = ''))
S_corr = readMat(paste('data/wpli/', sens, '/S_corr.mat', sep = ''))
...
ggsave(paste(sens, '_S_wpli', '.png', sep = ''))
...
ggsave(paste(sens, '_wpli_dot', '_s', '.png', sep = ''))
...
scatterplot + geom_point(size = 6) + labs(x = 'log(Behavioral Expression)', y = 'Skew') + 
  geom_smooth(method="lm", color = 'black') + theme_minimal() + scale_color_manual(values = rev(brewer.pal(4,'RdPu')))
ggsave(paste(sens, '_wpli_beta', '_s', '.png', sep = ''))
...
# load data
M = readMat(paste('data/wpli/', sens, '/M.mat', sep = ''))
M_corr = readMat(paste('data/wpli/', sens, '/M_corr.mat', sep = ''))
...
ggsave(paste(sens, '_M_wpli', '.png', sep = ''))
...
# load data
E = readMat(paste('data/wpli/', sens, '/E.mat', sep = ''))
E_corr = readMat(paste('data/wpli/', sens, '/E_corr.mat', sep = ''))
...
ggsave(paste(sens, '_E_wpli', '.png', sep = ''))
...
ggsave(paste(sens, '_dot', '_e_wpli', '.png', sep = ''))
...
ggsave(paste(sens, '_beta', '_e_wpli', '.png', sep = ''))
...
#############################################################################################
# load data
H = readMat(paste('data/wpli/', sens, '/H.mat', sep = ''))
H_corr = readMat(paste('data/wpli/', sens, '/H_corr.mat', sep = ''))
...
ggsave(paste(sens, '_H_wpli', '.png', sep = ''))
...
scatterplot + geom_point(size = 6) + labs(x = 'log(Behavioral Expression)', y = 'Shannon Entropy') + 
  geom_smooth(method="lm", color = 'black') + theme_minimal() + scale_color_manual(values = rev(brewer.pal(4,"Reds")))
ggsave(paste(sens, '_dot', '_h_wpli', '.png', sep = ''))
...
scatterplot + geom_point(size = 6) + labs(x = 'log(Behavioral Expression)', y = 'Shannon Entropy') + 
  geom_smooth(method="lm", color = 'black') + theme_minimal() + scale_color_manual(values = rev(brewer.pal(4,"Reds")))
ggsave(paste(sens, '_beta', '_h_wpli', '.png', sep = ''))
