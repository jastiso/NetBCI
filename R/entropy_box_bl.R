...
# load data
H = readMat(paste('data/H_bl.mat'))
H_corr = readMat(paste('data/H_corr_bl.mat'))
...
plot = ggplot(plot_data, aes(x = cond, y = H, col = cond, fill = band) )
...
ggsave(paste('dot', '_h', '_bl.png', sep = ''))
