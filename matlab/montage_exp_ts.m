...
% initialize
mod_exp_high = cell(nSubj*numel(bands)*numel(regions), 5);
...
for j = 1:numel(sensors)
    ...
    exp_l = mod_exp_low(:,4);
    save([R_dir_s, 'ts_mod_exp_high.mat'], 'subj_h', 'band_h', 'region_h', 'exp_h', 'slope')
    save([R_dir_s, 'ts_mod_exp_low.mat'], 'subj_l', 'band_l', 'region_l', 'exp_l', 'slope')
