...
for j = 1:numel(sensors)
    ...
    for i = 1:numel(bands)
        ...
        saveas(gca, [save_dir, bands{i}, '_sparsity_ts.png'], 'png')
    end
    
    % save data
    save([R_dir_s, 'Sp_ts.mat'], 'Sp_high', 'Sp_low', 'Sp_other');
    ...
    for n = 1:numel(bands)
        ...
        saveas(gca, [save_dir, bands{n}, '_skew_sg_ts.png'], 'png')
    end

    % save data
    save([R_dir_s, 'Ssg_ts.mat'], 'S_high', 'S_low', 'S_other');
