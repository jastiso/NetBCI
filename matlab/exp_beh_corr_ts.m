...
for j = 1:numel(sensors)
    ...
    xlabel('Frequency')
    ylabel('Subject')
    saveas(gca, [save_dir, 'ts_behavior_exp_corr.png'], 'png')
    save([R_dir, 'ts_max_exp_b_corr.mat'], 'max_corrs')
    save([R_dir, 'ts_min_exp_b_corr.mat'], 'min_corrs')
    ...
    xlabel('Frequency')
    ylabel('Subject')
    saveas(gca, [save_dir, 'ts_min_behavior_exp_corr.png'], 'png')
...
saveas(gca, [save_dir, 'ts_max_beta_alpha.png'], 'png')
...
saveas(gca, [save_dir, 'ts_sd_beta_alpha.png'], 'png')
...
saveas(gca, [save_dir, 'ts_max_beta_beta.png'], 'png')
...
saveas(gca, [save_dir, 'ts_sd_beta_beta.png'], 'png')
