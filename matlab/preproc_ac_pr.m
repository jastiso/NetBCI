    ...
    for j = 1:numel(condition)
        ...
        for k = subjs
            ...
            try
                ...
                pause(.1)
                saveas(gca, [img_dir, 'fft_before_pr.png'], 'png')
                ...
                for f = 1:numel(bands)
                    ...
                    save([save_dir, 'mag/', bands{f}, '_ac_pr'], 'amp_corr')
                    
                    %plot
                    figure(1); clf
                    imagesc(amp_corr);
                    colorbar
                    saveas(gca, [img_dir, 'mag/', bands{f}, '_ac_pr.png'], 'png')
                    ...
                    save([save_dir, 'grad/', bands{f}, '_ac_pr'], 'amp_corr')
                    ...
                    imagesc(amp_corr);
                    colorbar
                    saveas(gca, [img_dir, 'grad/', bands{f}, '_ac_pr.png'], 'png')
