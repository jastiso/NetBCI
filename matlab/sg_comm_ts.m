...
for j = 1:numel(sensors)
    ...
    for i = 1:numel(bands)
        ...
        saveas(gca, [save_dir, bands{i}, '_G_ts.png'], 'png')
    end
    
    % save data
    save([R_dir_s, 'G_ts.mat'], 'G_high', 'G_low', 'G_other');
    ...
    for n = 1:numel(bands)
        ...
        saveas(gca, [save_dir, bands{n}, '_eff_ts.png'], 'png')
    end

    % save data
    save([R_dir_s, 'Eff_ts.mat'], 'E_high', 'E_low', 'E_other');
