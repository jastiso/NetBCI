...
#%% Load data 
    ...
    data = io.loadmat(''.join([data_dir, 'wpli_lowres_', band, '_', eType, '_', subj, '.mat']))
...
#%% Use the best parameters
    ...
    np.save("".join([save_dir,'wpli_lowres_', band, '_params']), opt_param)
...
#%% Consensus clustering for best parameters
    ...
    np.save("".join([save_dir, 'wpli_lowres_',band, '_subset']), subset)
    np.save("".join([save_dir,'wpli_lowres_', band, '_coeff']), coeff)
    np.save("".join([save_dir, 'wpli_lowres_',band, '_err']), err)
